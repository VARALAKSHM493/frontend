...
export default function UserTable() {
    ...
    const handleUserDelet = async () => {
        try {
            const DeletUser = await axios.delete(`https://backend-lx8t.onrender.com/api/delete/${userId}`)
    ...
    const handleOnSubmit = async (e) => {
        ...
        try {
            const UpdatedUser = await axios.put(`https://backend-lx8t.onrender.com/api/update/${updatedUserId}`,value)
